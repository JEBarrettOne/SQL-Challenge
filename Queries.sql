...
employees.first_name, dept_manager.from_date, dept_manager.to_date FROM dept_manager
...
dept_emp.dept_no FROM employees 
LEFT JOIN dept_emp 
...
SELECT last_name, COUNT(*) AS freq_count FROM employees
GROUP BY last_name
